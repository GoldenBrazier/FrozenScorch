...
public:
    DictionaryBase() { }
    DictionaryBase(const Handle& handle)
        : Object(handle)
    {
    }
...
public:
    Dictionary() { }
    Dictionary(const Handle& handle)
        : DictionaryBase(handle)
    {
    }
};
